...
public class HoursMinutesSecondsLogic{
...
public static final int SECONS_IN_DAY = 86_400;
	...
	public static int calculateHours(int secondsBeforeN)  {
		...
		if (secondsBeforeN < 0) {
			//throw new OutOfRangeException("Секунда не может быть отрицательной");
			//пока не реализовано
		} else if (secondsBeforeN == 0) {
			//throw new OutOfRangeException("Секунда не может быть нулевой");
